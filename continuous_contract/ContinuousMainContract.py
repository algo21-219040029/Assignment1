...
class ContinuousMainContract:
    ...
    def get_continuous_main_contract_series(self, symbol: str, rebalance_date_num: int, field: str) -> DataFrame:
        ...
        start_price = price.iloc[0][main_contract_df['main_contract'].iloc[0]]
